...
cppcheck . --inline-suppr -q -i fixed-containers -i magic_enum -i emio -i filex -i FlashDB -i netxduo -i threadx -i build -i stm32h5xx_hal_driver -f --cppcheck-build-dir=build/cppcheck
cppcheck . --enable=style --inline-suppr --suppress=cstyleCast -q -i fixed-containers -i magic_enum -i emio -i lwjson -i filex -i FlashDB -i netxduo -i threadx -i build -i stm32h5xx_hal_driver -f --cppcheck-build-dir=build/cppcheck
